...
import com.gersion.library.multitype.inter.OneToManyFlow;
import com.gersion.library.multitype.inter.TypePool;
 ...
 * @author drakeet
 */
public class MultiTypeAdapter <T extends Filter, K extends BaseViewHolder>extends RecyclerView.Adapter<ViewHolder> {
...
//        this(Collections.emptyList());
     ...
     */
    public MultiTypeAdapter(@NonNull List<T> items, int initialCapacity) {
    ...
    public <T> void register(
        @NonNull Class<Filter> clazz, @NonNull ItemViewBinder<Filter, BaseViewHolder> binder) {
        checkAndRemoveAllTypesIfNeed(clazz);
        typePool.register(clazz, binder, new DefaultLinker<Filter>());
    }
